...
라즈베리파이와 시리얼 통신으로 연동하여 3단계 청소를 위한 하드웨어를 제어하는 Arduino 펌웨어입니다.
...
- **라즈베리파이 시스템**: [`../Raspberrypi/README.md`](../Raspberrypi/README.md)
- **하드웨어 전체 가이드**: [`../README.md`](../README.md)
- **하드웨어 연결 가이드**: [`HARDWARE_CONNECTION.md`](HARDWARE_CONNECTION.md)
- **전체 프로젝트**: [`../../../README.md`](../../../README.md)

---

**🎯 Arduino 목표**: 안정적이고 정확한 3단계 청소 하드웨어 제어 시스템 구현  
**🛠️ 개발 환경**: Arduino IDE 1.8.19+, PlatformIO Core 6.0+ 